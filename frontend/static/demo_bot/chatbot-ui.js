...
function init(botLogoPath) {
    ...
    template = ` <button class='chat-btn'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class='chat-popup'>
		...
		<div class='chat-header'>
			...
			<button class = "expand-chat-window" ><img src="./icons/open_fullscreen.svg" class="material-icon" ></button>
		</div>
    ...
    expandWindow.addEventListener("click", (e) => {
        ...
        if (expandWindow.innerHTML == '<img src="./icons/open_fullscreen.svg" class="material-icon">') {
            expandWindow.innerHTML = `<img src = "./icons/close_fullscreen.svg" class = 'material-icon'>`
            ...
            expandWindow.innerHTML = `<img src = "./icons/open_fullscreen.svg" class = "material-icon" >`
